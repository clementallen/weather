...
?>
        ...
        <div class="row" id="synoptics-page">
            ...
            <div class="col-md-4">
                <p class="lead webcam">Fronts and Rain for <?php echo $oneDay; ?></p>
            ...
            <div class="col-md-4">
                <p class="lead webcam">Fronts and Rain for <?php echo $twoDay; ?></p>
            ...
            <div class="col-md-4 col-md-offset-2">
                <p class="lead webcam">Fronts and Rain for <?php echo $threeDay; ?></p>
            ...
            <div class="col-md-4">
                <p class="lead webcam">Fronts and Rain for <?php echo $fourDay; ?></p>
            ...
            <div class="col-md-4">
                <p class="lead webcam">Synoptics for <?php echo $oneDay; ?></p>
            ...
            <div class="col-md-4">
                <p class="lead webcam">Synoptics for <?php echo $oneDay; ?> +12</p>
            ...
            <div class="col-md-4">
                <p class="lead webcam">Synoptics for <?php echo $twoDay; ?></p>
            ...
            <div class="col-md-4">
                <p class="lead webcam">Synoptics for <?php echo $twoDay; ?> +12</p>
            ...
            <div class="col-md-4">
                <p class="lead webcam">Synoptics for <?php echo $threeDay; ?></p>
