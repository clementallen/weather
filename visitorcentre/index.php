        ...
        <div class="row" id="visitorcentre-page">
            ...
            <div class="col-md-12">
                <div class="panel panel-default small-screen-hide">
                    <iframe src="https://www.dunstablehpc.com/gauges/gauges-ss-basic.htm" style="border:0px #FFFFFF none;" name="Dunstable Visitor Center Weather Station" scrolling="no" frameborder="0" marginheight="0px" marginwidth="0px" height="100%" width="100%"></iframe>
                </div>
